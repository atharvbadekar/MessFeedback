          ...
          <div className="flex justify-between h-20 items-center">
            <div className="flex items-center space-x-4">
              <div className="bg-white p-1.5 rounded-xl shadow-sm flex items-center justify-center">
                <img 
                  ...
                  onError={(e) => { e.target.onerror = null; e.target.src = "/images/curaj-logo.png"; }}
                />
              </div>
              <div>
                <h1 className="text-xl sm:text-2xl font-bold tracking-tight leading-tight">Mega Mess System</h1>
                <p className="text-xs sm:text-sm text-emerald-200 font-medium">Central University of Rajasthan</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="bg-white p-1 rounded-lg shadow-sm flex items-center justify-center">
                <img src="/logos/naac.jpeg" alt="NAAC" className="h-10 w-auto object-contain" onError={(e) => { e.target.onerror = null; e.target.src = "/logos/naac.jpg"; }} />
              </div>
              <div className="bg-white p-1 rounded-lg shadow-sm flex items-center justify-center">
                <img src="/logos/nirf.jpeg" alt="NIRF" className="h-10 w-auto object-contain" onError={(e) => { e.target.onerror = null; e.target.src = "/logos/nirf.jpg"; }} />
              </div>
            </div>
          </div>
        </div>
