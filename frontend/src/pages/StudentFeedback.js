...
import { User, KeyRound, Star, Send, CheckCircle2, ChevronRight, Fingerprint, Clock, Sparkles } from 'lucide-react';
        ...
        {step === 1 && (
          <div className="space-y-6">
            ...
            <div className="relative">
              ...
              <input 
                type="text" 
                placeholder="College ID (e.g. 2023MSBC001)"
          ...
          <div className="space-y-6 animate-in fade-in slide-in-from-right-4">
            <div className="bg-slate-50 rounded-[2rem] p-6 border border-slate-100 space-y-3">
              ...
              <div className="flex justify-between items-center text-xs font-medium text-slate-500">
                ...
                <span className="text-indigo-600 font-semibold">Hostel {studentData?.hostelId}</span>
              </div>
            </div>
            ...
            <button 
              ...
              disabled={loading}
              className="w-full bg-indigo-600 text-white py-4 rounded-2xl font-bold shadow-lg shadow-indigo-100 active:scale-95 transition"
            >
